...
const defaultCurrencies = ["GTQ", "EUR", "GBP", "INR"];
...
export default async function getExchangeRates(
  ...
  try {
    ...
    currencies.forEach((currency) => {
      output[currency] = data.rates[currency];
    });
    return output;
  } catch (error) {
    console.error(error);
...
// console.log(await getExchangeRates()); //{USDGTQ: 7.69729, USDEUR: 0.952604, USDGBP: 0.794565, USDINR: 86.66835}
// console.log(await getCurrencies());
// console.log(getFallbackCurrencies());
